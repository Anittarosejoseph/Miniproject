# Generated by Django 4.0.3 on 2024-03-18 13:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(blank=True, choices=[('ADMIN', 'Admin'), ('VENDOR', 'Vendor'), ('DELIVERYTEAM', 'Deliveryteam'), ('CUSTOMER', 'Customer'), ('TECHNICIAN', ' Technician')], default='CUSTOMER', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_upload', models.ImageField(blank=True, null=True, upload_to='watch_images/')),
                ...
                ('issue_types', models.ManyToManyField(to='horofixapp.watchrepairservice')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('watch_image', models.ImageField(default='watch_images/default_image.jpg', null=True, upload_to='watch_images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('thread', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chatmessage_thread', to='horofixapp.thread')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
