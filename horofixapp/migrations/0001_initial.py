# Generated by Django 4.2.7 on 2024-02-19 09:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('watch_modelnumber', models.CharField(max_length=255, null=True, unique=True)),
                ...
                ('category', models.CharField(choices=[('Men', 'Men'), ('Women', 'Women'), ('Kids', 'Kids')], default=None, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='horofixapp.watchrepairservice')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('watch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='horofixapp.watchproduct')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
